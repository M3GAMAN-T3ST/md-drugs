...
Config.MakePowder = { -- where you chop your coca leaves to make powder
    {loc = vector3(1979.84, -2613.6, 3.16), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}
...
---------------- Crack locations | POSTAL 9373 ---
Config.makecrack = { -- make crack with baking soda with cut coke 1-3
    {loc = vector3(1981.89, -2609.89, 3.13), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}

Config.bagcrack = { ---  bag crack 1-3 stages
    {loc = vector3(1978.92, -2606.77, 4.13), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}
------------------------- LSD Locations | POSTAL 6171 ---
Config.lysergicacid = { -- get lysergic acid
    {loc = vector3(-177.6, 405.21, 110.77), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
    {loc = vector3(2405.53, 5008.39, 46.02), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}

Config.diethylamide = { -- get diethylamide
    {loc = vector3(-175.95, 410.34, 110.77), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
...
------------ Heroin Locations | POSTAL 9102 ---
Config.dryplant = { -- turn resin into powder
    {loc = vector3(75.79, -1954.54, 21.01), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}

Config.cutheroinone = { -- cut heroin stage 1-3 with baking soda
    {loc = vector3(72.11, -1958.55, 21.01), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}

Config.fillneedle = { -- fill needles with heroin
    {loc = vector3(75.23, -1956.83, 21.21), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}

Config.buyheroinlabkit = vector4(-1361.08, -321.41, 39.53, 302.13) -- buy heroin lab kit
Config.heroinlabkitprice = 10000 -- price of the lsd lab kit

------------ XTC | POSTAL 4012 ---
Config.isosafrole = { -- where to steal isosafrole
    {loc = vector3(77.5, -814.23, 31.31), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}
...
Config.rawxtcloc = { --  where to combine the 2 ingridents to make raw xtc
    {loc = vector3(-29.72, 2885.61, 55.31), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}

Config.stamp = { --  where to stamp pills
    {loc = vector3(-27.41, 2886.69, 55.3), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}
...
-------------- lean | POSTAL ---
Config.SyrupVendor = vector4(362.71, -577.84, 39.3, 347.23) -- where the mission ped starts
...
Config.FillPrescription = {---------- this is where you want people to take their prescription to get a bottle of pills. They use bottle to get a random amount of prescription pills
    {loc = vector3(71.35, -814.04, 31.26), l = 1.0, w = 1.0, rot = 45.0, gang = ""},
}
...
Config.Items = { --- this is the store for the travelling merchant
    items = {
		[1] = {name = "mdp2p", 			 price = 25, 	amount = 50, 	},
		[2] = {name = "lysergic_acid",   price = 25, 	amount = 50, 	},
		[3] = {name = "diethylamide",    price = 25, 	amount = 50, 	},
		[4] = {name = "empty_weed_bag",  price = 2, 	amount = 1000, 	},
		[5] = {name = "isosafrole", 	 price = 25, 	amount = 1000,	},
		[6] = {name = "cokeburner", 	 price = 25, 	amount = 50, 	},
		[7] = {name = "crackburner", 	 price = 2, 	amount = 50, 	},
		[8] = {name = "lsdburner",		 price = 2, 	amount = 50, 	},
		[9] = {name = "heroinburner", 	 price = 2, 	amount = 50, 	},
		[10] = {name = "mdlean", 		 price = 50, 	amount = 50, 	},
        [11] = {name = "weedgrinder", 	 price = 25, 	amount = 50, 	},
		[12] = {name = "mdbutter", 		 price = 25, 	amount = 50, 	},
		[13] = {name = "dirtyheroinlabkit", price = 1000, amount = 50, 	},
		[14] = {name = "heroinlabkit",   price = 1000, 	amount = 50, 	},
		[15] = {name = "singlepress", 	 price = 1000, 	amount = 50, 	},
		[16] = {name = "dabrig", 		 price = 2, 	amount = 1000, 	},
		[17] = {name = "mdwoods", 		 price = 2, 	amount = 1000, 	},
		[18] = {name = "leancup", 		 price = 25, 	amount = 50, 	},
        [19] = {name = "xtcburner", 	 price = 25, 	amount = 50, 	},
